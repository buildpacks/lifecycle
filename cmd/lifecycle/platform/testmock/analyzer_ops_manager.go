...
// Source: github.com/buildpacks/lifecycle/cmd/lifecycle/platform (interfaces: AnalyzerOpsManager)
...
func (m *MockAnalyzerOpsManager) EnsureRegistryAccess(arg0 platform.AnalyzerOpts) platform.AnalyzerOp {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureRegistryAccess", arg0)
	ret0, _ := ret[0].(platform.AnalyzerOp)
	return ret0
}
...
func (m *MockAnalyzerOpsManager) WithBuildpacks(arg0 buildpack.Group, arg1 string) platform.AnalyzerOp {
	m.ctrl.T.Helper()
...
func (m *MockAnalyzerOpsManager) WithCache(arg0, arg1 string) platform.AnalyzerOp {
	m.ctrl.T.Helper()
...
func (m *MockAnalyzerOpsManager) WithLayerMetadataRestorer(arg0 string, arg1 bool, arg2 lifecycle.Logger) platform.AnalyzerOp {
	m.ctrl.T.Helper()
...
func (m *MockAnalyzerOpsManager) WithPrevious(arg0, arg1 string) platform.AnalyzerOp {
	m.ctrl.T.Helper()
...
func (m *MockAnalyzerOpsManager) WithRun(arg0 string) platform.AnalyzerOp {
	m.ctrl.T.Helper()
...
func (m *MockAnalyzerOpsManager) WithSBOMRestorer(arg0 string, arg1 lifecycle.Logger) platform.AnalyzerOp {
	m.ctrl.T.Helper()
