...
func FlagGeneratedDir(dir *string) {
	flagSet.StringVar(dir, "generated", envOrDefault(platform.EnvGeneratedDir, platform.PlaceholderGeneratedDir), "path to output directory for files generated by image extensions")
}
