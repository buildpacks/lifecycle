...
func (m *MockResolver) Resolve(arg0 []buildpack.GroupBuildable, arg1 *sync.Map) ([]buildpack.GroupBuildable, []platform.BuildPlanEntry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Resolve", arg0, arg1)
	ret0, _ := ret[0].([]buildpack.GroupBuildable)
