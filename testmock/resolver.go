...
func (m *MockResolver) Resolve(arg0 []buildpack.GroupBuildpack, arg1 *sync.Map) ([]buildpack.GroupBuildpack, []common.BuildPlanEntry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Resolve", arg0, arg1)
	ret0, _ := ret[0].([]buildpack.GroupBuildpack)
	ret1, _ := ret[1].([]common.BuildPlanEntry)
	ret2, _ := ret[2].(error)
