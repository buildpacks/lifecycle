...
func (m *MockLayerMetadataRestorer) Restore(arg0 []buildpack.GroupBuildpack, arg1 dataformat.LayersMetadata, arg2 platform.CacheMetadata, arg3 lifecycle.LayerSHAStore) error {
	m.ctrl.T.Helper()
