...
func (r *InputsResolver) fillDefaults(inputs *AnalyzeInputs, logger log.Logger) error {
...
func (r *InputsResolver) validate(inputs AnalyzeInputs, logger log.Logger) error {
