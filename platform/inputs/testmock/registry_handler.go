...
// Source: github.com/buildpacks/lifecycle/platform/inputs (interfaces: RegistryHandler)
...
func (m *MockRegistryHandler) EnsureReadAccess(arg0 []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureReadAccess", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockRegistryHandler) EnsureWriteAccess(arg0 []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureWriteAccess", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
