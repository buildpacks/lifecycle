...
require (
	...
	github.com/buildpacks/imgutil v0.0.0-20230523155828-e99e711d8210 // FIXME: point back to `main` branch when https://github.com/buildpacks/imgutil/pull/202 is merged
