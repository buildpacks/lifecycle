...
require (
	...
	github.com/buildpacks/imgutil v0.0.0-20230523170037-130a1695ff63 // FIXME: point back to `main` branch when https://github.com/buildpacks/imgutil/pull/202 is merged
