...
require (
	...
	github.com/buildpacks/imgutil v0.0.0-20260821195038-6047007ed8ea
	...
	github.com/osscontainertools/kaniko v1.28.3
...
require (
	...
	github.com/osscontainertools/docker-credential-acr v0.8.0 // indirect
