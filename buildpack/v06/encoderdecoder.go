...
func (d *EncoderDecoder06) Encode(file *os.File, lmf layermetadata.File) error {
...
func (d *EncoderDecoder06) Decode(path string) (layermetadata.File, string, error) {
	...
	return layermetadata.File{Data: lmtf.Data, Build: lmtf.Types.Build, Launch: lmtf.Types.Launch, Cache: lmtf.Types.Cache}, msg, nil
}
