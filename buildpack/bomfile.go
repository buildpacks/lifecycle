...
func (b *Descriptor) processBOMFiles(layersDir string, bp GroupBuildpack, pathToLayerMetadataFile map[string]layermetadata.File, logger Logger) ([]BOMFile, error) {
	var (
